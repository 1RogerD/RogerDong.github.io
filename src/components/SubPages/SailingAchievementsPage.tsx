...
import { ArrowLeft, Anchor, Trophy, Calendar, MapPin, Award } from 'lucide-react';

interface SailingAchievementsPageProps {
  onBack: () => void;
}

const SailingAchievementsPage: React.FC<SailingAchievementsPageProps> = ({ onBack }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-4xl font-bold">Sailing Achievements</h1>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-red-800 to-red-900 rounded-xl p-6 mb-4 border border-red-600">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-red-200">HOBIE 16 Asian Championships</h3>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-red-800/50 rounded-xl p-6 border border-red-600">
              ...
              <p className="text-red-200 mb-4">United Kingdom</p>
            ...
            <div className="bg-red-800/50 rounded-xl p-6 border border-red-600">
              ...
              <p className="text-red-200 mb-4">United States</p>
              <ul className="space-y-2 text-red-100">
        ...
        <div className="bg-gradient-to-br from-red-900 to-red-800 rounded-2xl p-8 border border-red-700">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h3 className="text-xl font-bold mb-4 text-yellow-300">7+ Years</h3>
              <p className="text-red-100">Continuous training since age 6</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4 text-yellow-300">500+ Hours</h3>
              <p className="text-red-100">On-water experience</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4 text-yellow-300">12+ Competitions</h3>
              <p className="text-red-100">Regional and national events</p>
            </div>
          </div>
        </div>
      </div>
...
export default SailingAchievementsPage;